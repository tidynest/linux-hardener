...
`scripts/validate/` holds seventeen Python 3 scripts: the master runner
`validate_all.py`, the auto-updater `update_all_docs.py`, the fourteen
...
and it is why the run reports fifteen checks against fourteen Python
validators.
