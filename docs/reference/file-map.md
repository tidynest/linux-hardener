...
The table covers the ten crates under `crates/` and sums to 2115. The eleventh
workspace member, `src-tauri`, carries 132 more, which is why the tree total the
evidence ledger records is 2247 and not this table's sum.
