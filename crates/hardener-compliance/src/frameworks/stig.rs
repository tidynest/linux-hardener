...
pub fn get_controls() -> Vec<ComplianceMapping> {
    vec![
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must implement address space layout
  randomization (ASLR)".to_string(),
            compliance_section: Some("Kernel Security".to_string()),
        },
        ComplianceMapping {
            compliance_framework: ComplianceFramework::STIG,
            compliance_control_id: "V-230281".to_string(),
            compliance_control_title: "RHEL must restrict exposed kernel pointer
  addresses".to_string(),
            compliance_section: Some("Kernel Security".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must restrict access to the kernel message
  buffer".to_string(),
            compliance_section: Some("Kernel Security".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must disable core dumps for SUID
  programs".to_string(),
            compliance_section: Some("Kernel Security".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must use reverse path filtering on all IPv4
  interfaces".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must not permit direct root login via
  SSH".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must not allow SSH with empty
  passwords".to_string(),
            compliance_section: Some("SSH Configuration".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must disable X11 forwarding via
  SSH".to_string(),
            compliance_section: Some("SSH Configuration".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must limit SSH authentication
  attempts".to_string(),
            compliance_section: Some("SSH Configuration".to_string()),
        },
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must have the audit system installed and
  enabled".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must require passwords of at least 14
  characters".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must enforce password maximum
  lifetime".to_string(),
            compliance_section: Some("Authentication".to_string()),
        },
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "RHEL must have a host-based firewall
  enabled".to_string(),
            compliance_section: Some("Network Security".to_string()),
        },
    ]
