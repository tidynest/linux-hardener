...
pub fn get_controls() -> Vec<ComplianceMapping> {
    vec![
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Inbound traffic is restricted to only authorised traffic"
                .to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Outbound traffic is restricted to only authorised traffic"
                .to_string(),
            compliance_section: Some("Network Security Controls".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Configuration standards are developed and implemented"
                .to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Only necessary services and protocols are enabled"
                .to_string(),
            compliance_section: Some("Secure Configurations".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "System security parameters are configured to prevent misuse"
                .to_string(),
            compliance_section: Some("Secure Configurations".to_string()),
        },
        // ===========================================
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Anti-malware solution is deployed on all applicable systems"
                .to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title:
                "Access control model is defined and includes granting appropriate access"
                    .to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Access is assigned based on job classification and function"
                .to_string(),
            compliance_section: Some("Restrict Access".to_string()),
        },
        // ===========================================
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Strong authentication for users and administrators"
                .to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Password history prevents reuse of last four passwords"
                .to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title:
                "Interactive login for system/application accounts is restricted".to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        // ===========================================
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "All individual user access to cardholder data is logged"
                .to_string(),
            compliance_section: Some("Log and Monitor".to_string()),
        },
        ComplianceMapping {
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "All changes to authentication credentials are logged"
                .to_string(),
            compliance_section: Some("Log and Monitor".to_string()),
        },
    ]
