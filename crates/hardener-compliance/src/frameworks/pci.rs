...
pub fn get_controls() -> Vec<ComplianceMapping> {
    vec![
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Inbound traffic is restricted to only authorised
  traffic".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Strong authentication for users and
  administrators".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Invalid authentication attempts are
  limited".to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "Passwords meet minimum complexity
  requirements".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "Passwords are changed at least every 90
  days".to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "Password history prevents reuse of last four
  passwords".to_string(),
            compliance_section: Some("Identify and Authenticate".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "Interactive login for system/application accounts is
  restricted".to_string(),
        ...
        ComplianceMapping {
            ...
            compliance_control_title: "All individual user access to cardholder data is
  logged".to_string(),
            compliance_section: Some("Log and Monitor".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "All actions by privileged users are
  logged".to_string(),
            compliance_section: Some("Log and Monitor".to_string()),
        },
        ComplianceMapping {
            ...
            compliance_control_title: "All changes to authentication credentials are
  logged".to_string(),
            compliance_section: Some("Log and Monitor".to_string()),
        },
    ]
