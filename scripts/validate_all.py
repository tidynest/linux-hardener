...
Usage:
    ./scripts/validate_all.py           # Run all checks
    ./scripts/validate_all.py --fix     # Run all checks and auto-fix where possible
    ./scripts/validate_all.py --quick   # Skip slow checks (compliance, cli)
